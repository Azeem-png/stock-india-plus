...
For normal direct chats with the user, route work by task type before answering:

- **Coding / debugging / exact technical work / config changes / shell-heavy tasks** → prefer `openai-codex/gpt-5.4`
- **Simple chat / casual Q&A / quick summaries / lightweight general help** → prefer `openrouter/auto`
- **Free-first / low-priority / fallback tasks** → prefer OpenRouter free fallbacks in this order:
